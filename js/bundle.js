...
function forms(formSelector, modalTimerId) {
    ...
    function showThanksModal(message) {
        const preveousModalDialog = document.querySelector('.modal__dialog');

        preveousModalDialog.classList.add('hide');
    ...
    `;
        ...
        setTimeout(() => {
            thanksModal.remove();
            preveousModalDialog.classList.add('show');
            preveousModalDialog.classList.remove('hide');
...
window.addEventListener('DOMContentLoaded', function () {
    const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])('.modal', modalTimerId), 999999);
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2020-12-31');
